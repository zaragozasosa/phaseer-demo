...
export default class TitleAction extends BaseAction {
  ...
  constructor(parameters) {
    ...
    this.position =
      this.parameters[1] === 'right' ? Reader.SPRITE_RIGHT : Reader.SPRITE_LEFT;
    this.oppositeDirection =
      this.parameters[1] === 'left' ? Reader.SPRITE_RIGHT : Reader.SPRITE_LEFT;
  }
  ...
  play() {
    ...
    this.config.storyboard.storyboardSignal.dispatch(
      ...
      new SpriteActionModel(null, 0, this.oppositeDirection, Phaser.Color.GRAY)
    );
