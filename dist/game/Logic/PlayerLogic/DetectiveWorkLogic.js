...
var DetectiveWorkLogic = (function (_super) {
    __extends(DetectiveWorkLogic, _super);
    function DetectiveWorkLogic(gameboardConfig) {
        return _super.call(this, gameboardConfig) || this;
    }
    DetectiveWorkLogic.prototype.power = function () {
    ...
    DetectiveWorkLogic.prototype.canUsePower = function () {
        var tiles = this.getTilesOrdered();
    ...
    return DetectiveWorkLogic;
}(LogicalGrid_1.default));
exports.default = DetectiveWorkLogic;
