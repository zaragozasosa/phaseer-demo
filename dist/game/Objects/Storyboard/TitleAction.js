...
var TitleAction = (function (_super) {
    ...
    function TitleAction(parameters) {
        ...
        _this.position = _this.parameters[1] === 'right' ? Reader_1.default.SPRITE_RIGHT : Reader_1.default.SPRITE_LEFT;
        _this.oppositeDirection = _this.parameters[1] === 'left' ? Reader_1.default.SPRITE_RIGHT : Reader_1.default.SPRITE_LEFT;
        return _this;
    }
