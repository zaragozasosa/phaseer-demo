...
var SpriteAction = (function (_super) {
    ...
    function SpriteAction(parameters) {
        ...
        _this.position = _this.parameters[2] === 'right' ? Reader_1.default.SPRITE_RIGHT : _this.parameters[2] === 'left' ? Reader_1.default.SPRITE_LEFT : Reader_1.default.SPRITE_BOTH;
