...
var PowerWindow = (function (_super) {
    ...
    function PowerWindow(character) {
        ...
        if (character.friendId) {
            sprites.add(_this.tools.sprite.createFromSpriteSheet(90, y, character.spriteId, character.specialSpriteFrame, 1.8));
            sprites.add(_this.tools.sprite.createFromSpriteSheet(520, y, character.friendSpriteId, character.specialSpriteFrame, 1.8));
        }
        else {
            sprites.add(_this.tools.sprite.makeCenteredFromSpriteSheet(y, character.spriteId, character.specialSpriteFrame, 2));
        }
