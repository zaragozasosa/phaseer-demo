...
var GameboardConfig = (function () {
    ...
    GameboardConfig.prototype.createTiles = function () {
        ...
        list.push(new TileModel_1.default('bren', 'B.R.E.N.', 'brotherhating ridiculously efficient nerd.py', 'meushijyo', 'yawn.mp3', 'powerGaming', this.powers.find(function (x) { return x.id === 'powerGaming'; }), 'Cutting-edge sentient Artificial Intelligence who even rewrote her own name. Instead of planning the end of the world, or paying any attention to his maker, this script enjoys crunching numbers, playing games and explaining why other players suck.'));
