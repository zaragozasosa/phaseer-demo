...
var GameboardConfig = (function () {
    ...
    GameboardConfig.prototype.createTiles = function () {
        ...
        list.push(new TileModel_1.default('mira', 'Mira', 'Black Witch Mira', 'fancy', 'ahaha.wav', 'blackMagic', 'Black Magic', "A fickle, cruel witch who enjoys throwing humans inside murder games and watching them lose their sanity. She's also a low-profile online writer who only publishes using pen names."));
        list.push(new TileModel_1.default('fancy', 'Lord Fancy', 'Sir Lord Fancypants', 'lord-fancy', 'hyehye.mp3', 'blackMagic', 'Black Magic', 'Fancy demon by day, even fancier by night. This creature of elegant nature was contracted by Mira to capture humans, fend off witch hunters, and bake cookies.'));
        list.push(new TileModel_1.default('nacho', 'Nacho', 'Ignacio Zaragoza', 'chili', 'gunshot.mp3', '5DeMayo', 'Cinco de Mayo', 'A simple guy who claims to be the long-lost descendant of a deceased famous general. Enjoys lazing around his computer and drinking overpriced beer. His dog Chili often gets lost when visiting the park.'));
        list.push(new TileModel_1.default('chili', 'Chili', 'Chili Bagel', 'nacho', 'howl.mp3', '5DeMayo', 'Cinco de Mayo!', "Hey, you shouldn't be able to read this!", false));
        this.groups = [];
