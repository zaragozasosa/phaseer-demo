...
var OldCharacterSelection = (function (_super) {
    __extends(OldCharacterSelection, _super);
    function OldCharacterSelection() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    OldCharacterSelection.prototype.preload = function () {
    ...
    OldCharacterSelection.prototype.create = function () {
        ...
        displayArray = characters.filter(function (x) { return x.isMenuVisible; });
    ...
    OldCharacterSelection.prototype.gameStart = function () {
        var _this = this;
    ...
    OldCharacterSelection.prototype.setSelectedCharacter = function (sprite, char) {
    ...
    OldCharacterSelection.prototype.update = function () {
        if (this.inputManager.checkKeys() === Phaser.Keyboard.ENTER) {
            this.gameStart();
        }
    };
    return OldCharacterSelection;
}(Phaser.State));
exports.default = OldCharacterSelection;
